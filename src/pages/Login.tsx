...
import { Scale, LogIn, Mail, UserPlus } from 'lucide-react';
      ...
      <Card className="max-w-md w-full shadow-2xl border-none rounded-3xl overflow-hidden">
        <CardHeader className="bg-slate-900 text-white text-center py-12 relative overflow-hidden">
          ...
          <CardDescription className="text-slate-400 mt-2 relative z-10 font-medium">
            {isSignUp ? 'Join Legal Help Kolkata today' : 'Login to your legal dashboard'}
          </CardDescription>
        </CardHeader>
            ...
            <form onSubmit={handleEmailAuth} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  {!isSignUp && <button type="button" className="text-xs text-blue-600 font-bold">Forgot?</button>}
                </div>
                <Input 
                  id="password" 
                  type="password" 
